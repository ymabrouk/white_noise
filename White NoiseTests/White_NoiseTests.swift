...
class White_NoiseTests: XCTestCase {
    ...
    class ViewControllerMock : NoisilyViewController {
        ...
        override func setColor(color: noisilyMainPresenter.NoiseColors) {
    ...
    override func setUp() {
        ...
        presenter = noisilyMainPresenter(viewController: viewController)
    ...
    func testChangeColor() {
        presenter.changeColor(color: noisilyMainPresenter.NoiseColors.Pink);
        XCTAssert(presenter.getColor() == noisilyMainPresenter.NoiseColors.Pink)
